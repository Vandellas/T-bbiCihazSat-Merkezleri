...
(function (factory) {
    ...
    $.fn.fileinputLocales.tr = {
        ...
        removeLabel: 'Sil',
        removeTitle: 'Seçilen dosyalarý sil',
        cancelLabel: 'Ýptal',
        cancelTitle: 'Devam eden yüklemeyi iptal et',
        uploadLabel: 'Yükle',
        uploadTitle: 'Seçilen dosyalarý yükle',
        msgNo: 'Hayýr',
        msgNoFilesSelected: '',
        msgCancelled: 'Iptal edildi',
        msgZoomModalHeading: 'Detaylý Önizleme',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: '"{name}" dosyasýnýn boyutu (<b>{size} KB</b>) izin verilen azami dosya boyutu olan <b>{maxSize} KB</b>\'tan büyük.',
        msgFilesTooLess: 'Yüklemek için en az <b>{n}</b> {files} dosya seçmelisiniz.',
        msgFilesTooMany: 'Yüklemek için seçtiðiniz dosya sayýsý <b>({n})</b> azami limitin <b>({m})</b> altýnda olmalýdýr.',
        msgFileNotFound: '"{name}" dosyasý bulunamadý!',
        msgFileSecured: 'Güvenlik kýsýtlamalarý "{name}" dosyasýnýn okunmasýný engelliyor.',
        msgFileNotReadable: '"{name}" dosyasý okunabilir deðil.',
        msgFilePreviewAborted: '"{name}" dosyasý için önizleme iptal edildi.',
        msgFilePreviewError: '"{name}" dosyasý okunurken bir hata oluþtu.',
        msgInvalidFileName: 'Invalid or unsupported characters in file name "{name}".',
        msgInvalidFileType: '"{name}" dosyasýnýn türü geçerli deðil. Yalnýzca "{types}" türünde dosyalara izin veriliyor.',
        msgInvalidFileExtension: '"{name}" dosyasýnýn uzantýsý geçersiz. Yalnýzca "{extensions}" uzantýlý dosyalara izin veriliyor.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgValidationError: 'Doðrulama Hatasý',
        msgLoading: 'Dosya yükleniyor {index} / {files} &hellip;',
        msgProgress: 'Dosya yükleniyor {index} / {files} - {name} - %{percent} tamamlandý.',
        msgSelected: '{n} {files} seçildi',
        msgFoldersNotAllowed: 'Yalnýzca dosyalarý sürükleyip býrakabilirsiniz! {n} dizin(ler) göz ardý edildi.',
        msgImageWidthSmall: '"{name}" adlý görüntü dosyasýnýn geniþliði en az {size} piksel olmalýdýr.',
        msgImageHeightSmall: '"{name}" adlý görüntü dosyasýnýn yüksekliði en az {size} piksel olmalýdýr.',
        msgImageWidthLarge: '"{name}" adlý görüntü dosyasýnýn geniþliði {size} pikseli geçemez.',
        msgImageHeightLarge: '"{name}" adlý görüntü dosyasýnýn yüksekliði {size} pikseli geçemez.',
        msgImageResizeError: 'Görüntü boyutlarýný yeniden boyutlandýrmak için alýnamadý.',
        msgImageResizeException: 'Görsel boyutlandýrma sýrasýnda hata.<pre>{errors}</pre>',
        dropZoneTitle: 'Dosyalarý buraya sürükleyip býrakýn &hellip;',
        dropZoneClickTitle: '<br>(ya da {files} seçmek için týklayýnýz)',
        fileActionSettings: {
            removeTitle: 'Dosyayý kaldýr',
            uploadTitle: 'Dosyayý yükle',
            zoomTitle: 'Ayrýntýlarý görüntüle',
            dragTitle: 'Taþý / Yeniden düzenle',
            indicatorNewTitle: 'Henüz yüklenemedi',
            indicatorSuccessTitle: 'Yüklendi',
            indicatorErrorTitle: 'Yükleme Hatasý',
            indicatorLoadingTitle: 'Yükleniyor ...'
        },
        previewZoomButtonTitles: {
            prev: 'Önceki dosyayý görüntüle',
            next: 'Sonraki dosyayý görüntüle',
            toggleheader: 'Baþlýk geçiþ',
            fullscreen: 'Tam ekran geçiþ',
            borderless: 'Çerçevesiz moda geçiþ',
            close: 'Detaylý önizlemeyi kapat'
        }
    };
